...
default_config = ConfigModel(
    ...
    nn_model_path="/home/key/dora-pika/dora-gelsight/src/models/nnmini.pt",
...
class GSConfig:
    ...
    def save_config(self: Self, save_path: str = None) -> None:
        """
    ...
    def reset_to_default(self: Self) -> None:
        """
